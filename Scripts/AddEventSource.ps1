<#
.Synopsis
   Adds Management Reporter Event Log source.
.DESCRIPTION
   Registers the Management Reporter Event Log source so events can be properly written to.
#>
[CmdletBinding()]
Param
(
...
$addEventSourceScript = New-ScriptExecution -Name 'Adding event source' `
	-ErrorCode $ErrorCodes.AddEventSource `
	-Script {
		Import-MRDeployModule
		Show-MRDeployVersion
		New-MREventLogSource
	}

Invoke-ExecutionScript -ExecutionScript $addEventSourceScript
# SIG # Begin signature block
# MIIjhgYJKoZIhvcNAQcCoIIjdzCCI3MCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB6nb4hLDUT9uFA
# I0ofzsr+tEW9ez1IYrTGcSD4KNrsnaCCDYEwggX/MIID56ADAgECAhMzAAACUosz
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgS6Tb4YDA
# 6MOg95Sn36tB8kERpDReyxBD3yFM68jY6RUwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQCdC4PhEhzUdAfTjor+TSPcjYixHMPqk9fKSWefBkuJ
# h3h9y/+CGBZfz15Cnaf0maxpNS0pjPxN8IYyzLEDyGBjGbIQMwEVXclpyxRfAtmR
# JUswpIcOrDyGncKiSFX5UFBCG+152JDbuM1Nj/inXyANiWJxiH40TBon2GK8tT08
# GrXIc6l0TRgM1RqnBQk9OECig8o7Ly+PAubE/BWi1JYQmyplY8yXtBbrQpsNTb4J
# YKI9eHfbMfu5VMaAmYVWhivucEA71FMmvpevt5sNzEoUVO+PGsuMGPSJfSnvYr4V
# zZdwQWhI0b3eaeMa6calml2rk1of9/toLz9CPA3flrbCoYIS5TCCEuEGCisGAQQB
# gjcDAwExghLRMIISzQYJKoZIhvcNAQcCoIISvjCCEroCAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIKs1UOlf9Oey7NOlzEP9Uu1fLsczkZXlGmZgirLj
# wFQuAgZhktY0+bMYEzIwMjExMjAxMDgzNzA5LjUxM1owBIACAfSggdCkgc0wgcox
...
# CSqGSIb3DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgz4FjtEXW
# 82+Bm7xrQHSu2oKZH+LE/NeU9iS/RTey880wgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
# DQEBCwUABIIBAGKS+lPuyZzpL8O0fMcs/Bi5npKpM1HA5Tz6HXMLJKPFPW+4YqGy
# lm3SlvTazwrWHkw4PDnn2M8vUUCBSn8RuYJno+ptlAQ6bOJDiwt2a3mbNjcJy3DY
# f9X9XmhF6bJgWQhetOS5YQUWmukq9lOphdbMtEIDoNjjZNnENDlbSCxLApGG3hh+
# izBZ5dbYMJsUMtEdqx0T1Azbe+Jgpkrg/+wAREsw0H9zysbEIeUm3frm4ZmcDXpy
# QCVzMeC4dz+olrrZcnI9hF9ABzGn7qrZIKnBHf4I1WTGewNJa764M7GoOxsv944S
# Bg/tyK5BCBvAsCnY8LkbZec4LkUGRBYd6NE=
