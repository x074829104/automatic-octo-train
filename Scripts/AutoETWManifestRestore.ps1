...
try
{
    ...
    if ($RestoreApplicable)
    {
        ...
        foreach ($File in $RemoveFiles)
        {
            ...
            try
            {
                Invoke-WithRetry -codeBlock { Remove-Item -Path $($File.FullName) -Force }  -scriptName "Remove $($File.FullName)" -maxRetry 3 -sleepTimeInSecond 1
            }
            catch
            {
                $RemoveErrorCount += 1
        ...
        if ($RemoveErrorCount -gt 0)
        {
            Write-Message "Error: Failed to remove $RemoveErrorCount files from Monitoring manifest folder."
            $ErrorMessages += "Failed to remove $RemoveErrorCount files from Monitoring manifest folder."
        ...
        foreach ($File in $RestoreFiles)
        {
            ...
            try
            {
                Invoke-WithRetry -codeBlock { Copy-Item -Path $($File.FullName) -Destination $DestinationFilePath -Force }  -scriptName "Copy $($File.FullName)" -maxRetry 3 -sleepTimeInSecond 1
            }
            catch
            {
                $RestoreErrorCount += 1
        ...
        if ($RestoreErrorCount -gt 0)
        {
            Write-Message "Error: Failed to restore $RestoreErrorCount files to Monitoring manifest folder."
            $ErrorMessages += "Failed to restore $RestoreErrorCount files to Monitoring manifest folder."
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBfxPO2uPI21d7F
# SWTnFF270lyPJx0Je8nZQvPUOJCPhKCCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgAv2eDBQV
# TA2zA7K/tWvjbV5M0it/PTkpIxt56R9+yzAwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQA0cn4C41E78qRAO+w+0Zof0HN+Vemoag6qZHo4GKwL
# eag/7nIMCj+0qbpFlqoBMnDiusvxEqv9Y/B+Na9PvFRag27rpoeKIsx8mZaAcpqw
# RIgaFfe405BYW7geMlAmkOrSQI1UR25AZZr+MUujUHzJU8Rw+uDxhTpQFNlJjMbp
# IwCuvVZ/ohJU6Jvhnf/NT+FEMfJe+1AA+WRr3zovoKOBYOOc9Jfsq4AcM2sV7M4p
# Z4xi/uMPRY1Zt6SlddS6fROmnjUHBijI0sup5Z+/XKENGvqS2R43pm6E+8sEvnk6
# UhSYs2+SbC6XQEbYbdeggbhvT+3rOKvzP3LOdZu53I5eoYIS/jCCEvoGCisGAQQB
# gjcDAwExghLqMIIS5gYJKoZIhvcNAQcCoIIS1zCCEtMCAQMxDzANBglghkgBZQME
# AgEFADCCAVkGCyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIEX5IPWW5ykwjzxSjFBF7e0aKZq3dJwbWYCj/cH1
# 8IPFAgZhgwt70r0YEzIwMjExMTExMDMxMzE0LjUyOFowBIACAfSggdikgdUwgdIx
...
# AQQwLwYJKoZIhvcNAQkEMSIEIODjJgrUpg68QgOX9Bcpls7ics1eKhOi69h1qhE3
# kjYUMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgUT8BPIzqc3SecHRPLKBt
...
# 4jPdwgnIQDbe07uARxK0ADANBgkqhkiG9w0BAQsFAASCAQBHX2RhW/Fu+Z/PrQYv
# wMA9Xv3LO7ugeVdS+mLKjb6jCRGEX4NLeyIhtYsE6usm2gdmGjDdZhzUMSjomj6n
# 0pkblftXq8r/F1oFwOHu1O9ZKjQN+KZN1fhUPBN1CgFOMd+OVRVuszmebK+0b+jV
# LrQrJ8GNesEq/NlDOWsXfwSNIi10lxKsRGzoIjOt+A6YCo+HmpxaTx9QpgS+cIrA
# XHZTzZL/NBtvuMZC7I1XwamEtoPN+oDmBaNUoux7/TuaJn9Nl6/XGxePekN9y9ct
# BQbwRmWllbYfnGyUzbwIh76CLRlbNg39i4+rjX0DFYEkcR/9586M3l9VENTuN3QZ
# wBRq
