<#
.SYNOPSIS
    Refresh the ETW manifest file registration.

.DESCRIPTION
    The script will look for the MonitoringInstall scheduled task and start it.
    It will run the MonitoringInstall.exe tool to register the ETW events from the
    instrumentation folder, generate a new MDS config, and start the Monitoring
    Agent processes. MonitoringInstall-Servicing.psm1 must exist in the script folder.
...
try
{
    ...
    {
        # Add log file name.
        $LogPath = Join-Path -Path $LogDir -ChildPath "Monitoring-EtwRefresh_$([DateTime]::UtcNow.ToString("yyyyMMddHHmmss")).log"
...
catch
{
    ...
    if ($LogPath)
    {
        ...
        "ETW refresh script failed with exit code: $($ExitCode)." | Out-File -FilePath $LogPath -Append
    }
...
try
{
    Write-Message "Script to refresh ETW manifest files starting..."
...
catch
{
    ...
    $ErrorMessage = "Error during ETW refresh: $($_)"

    Write-Message $ErrorMessage
    Write-Message "$($_.ScriptStackTrace)" -Vrb
    Write-Message "$($_.Exception)" -Vrb
    Write-Message "ETW refresh script failed with exit code: $($ExitCode)."
...
Write-Message "ETW refresh script completed with exit code: $($ExitCode)."
exit $ExitCode
# SIG # Begin signature block
# MIIjnwYJKoZIhvcNAQcCoIIjkDCCI4wCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCfbpEB+6fJtRVO
# F9g9zALUoYGJ+t938h1i/eNRZDqmA6CCDYEwggX/MIID56ADAgECAhMzAAAB32vw
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgSsS2u6m4
# DYnWcYnYL+wOWFuzvH+hUn51QSSqAOzlyG0wQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQBgZSep1Yc4TQ+QzgQ85y2Co2yAov5cAl4YB0B75QWS
# lUzTeGLwV5MfX6mY8Isxul3Kjn6V5Z7bqy3ma4h5Z4Aa9Jt8DIEnnSaYVQvfLprB
# jIcTlplf8DzOeI8yqB5iudaiDkNh2K6DYWeQWQNidX9LhAwjdC3ZlHM03ObubssN
# mWsCIEJbu7gE3ICfOhS/Neyd3RnW+spQWPLHJR0/qZyzw2oDoeos6UtWVd1y+DnB
# pG87KV5YTTmBR1h7/i0kMZZo8W+Z8SyLOua55Yb32n1Ujn32QDFfK9cSc7U5NEgh
# 1BK+NJ7Z9rBx5f/V6LKPkXFhQl2nHVCF9fh27/66T3aBoYIS/jCCEvoGCisGAQQB
# gjcDAwExghLqMIIS5gYJKoZIhvcNAQcCoIIS1zCCEtMCAQMxDzANBglghkgBZQME
# AgEFADCCAVkGCyqGSIb3DQEJEAEEoIIBSASCAUQwggFAAgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEILIoKrG0a214mXIaxeZw3sXR7fsQd1l3uvqOagnS
# bKwGAgZhgwt70vQYEzIwMjExMTExMDMxMzE1LjE0OVowBIACAfSggdikgdUwgdIx
...
# AQQwLwYJKoZIhvcNAQkEMSIEIC2rkX7gzd8rwuM8cNmiKrbQCE5nG7E0prv6wJDB
# tatkMIH6BgsqhkiG9w0BCRACLzGB6jCB5zCB5DCBvQQgUT8BPIzqc3SecHRPLKBt
...
# 4jPdwgnIQDbe07uARxK0ADANBgkqhkiG9w0BAQsFAASCAQAJopEJBZ4mMMXpjZnl
# c9p/6I/jc3iZSM7LjlDRNWAAt9umeh/ZqFkG/xsl4ipGQKi+wu/4r9IoDxGQpW+B
# m/9FiezQ+ISYVEhkxWOuH/CClzM6jJfDzamJgbHoFHapH2hc65ETn7UufDatl5DS
# Z6t3+V6tjLSGw67krTOIeOTMvKjs0IADRMC/+5q5d4zxkvXBnHPGjB9AJw0E+XPd
# dfr1Ed30tNPK80zOau067QpDFuHP02jOxk4UJ2C1o0JTnsDsAFdwQVwS/jMCiSEZ
# fujvMUsE2K+WrXZYWWpLC5dVxCReftvDYCIF53Vd9/ccZY2nX8dj1G+aF4B1sth9
# aORP
