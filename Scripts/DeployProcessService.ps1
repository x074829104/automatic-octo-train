<#
.Synopsis
   Deploys Management Reporter Process Service
.DESCRIPTION
   Deploys Management Reporter NT Windows Process Service using the values contained within $MRDefaultValues or $config.
#>
[CmdletBinding()]
Param
(
...
$deployProcessServiceScript = New-ScriptExecution -Name 'Deploying Process Service' `
	-ErrorCode $ErrorCodes.DeployProcessService `
	-Script {
		...
		New-MRProcessService
	}

Invoke-ExecutionScript -ExecutionScript $deployProcessServiceScript
# SIG # Begin signature block
# MIIjhgYJKoZIhvcNAQcCoIIjdzCCI3MCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC+nmLpsAZjMmZt
# Dn0EWKYz5a495W/tit/dzr4kZrDl3qCCDYEwggX/MIID56ADAgECAhMzAAACUosz
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg2+84rfm1
# Gwlc/TUxgoKGa8Zhd2oiiTaVcxCyv2UTMW8wQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQAD0z7/Pd6gNwMAr5Tx4E66ZijimJpIN507B4nsm6BB
# UCQDuGInw+t7J4/ljgor8OejchFDSb9S9G9djf3i7aJB1ifChkGOlQvD3Ol4/QG6
# 37YQ8mjXbbMRkLzhokYjQ7IWF9xY8w/9RnV09qMDr7UBzrkE6Gk+uK7nj6nr+RxT
# aR/r3BqysXvP2J3c0JzXiXbvWkJ6WEso4R479sZbZqI268la23Ereo+OfEJR9AJz
# LqVRHSI5x4mVXBEevDME9X5dTEntfVfC1nOoKyxEpWeIz6CeFGhoLvA5GTgOwcMN
# I9wZknRCvKKCQgu+7Zrtj2YSrBKEu4kGlV8LsMI+XliooYIS5TCCEuEGCisGAQQB
# gjcDAwExghLRMIISzQYJKoZIhvcNAQcCoIISvjCCEroCAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEILcMYx8a1ltrgrocLzsvUh1Gf3Bbti/7EYmrMIsj
# ls7jAgZhktY1BNUYEzIwMjExMjAxMDgzODAwLjQ4NVowBIACAfSggdCkgc0wgcox
...
# CSqGSIb3DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgEWHMntdQ
# c+sJK86Ef9WuARucJMvN3f0jVGzRJb2rmvkwgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
# DQEBCwUABIIBADl8SEvCajkxYVmpRB/tcMfx/CwZ3DYuqvG1I74WLk6IxccF31TQ
# opBW/Ph+KtDD6Ns8NBV0419xPCNvETF6v1dyChyUxTmfPYN0b1eyr7pedBQytvfQ
# Tal7tR2HEWlZosrSHKE7iLMNjDkvZzEMZNHxK/oclt4v06AojGZaKV5nSkRxeW7g
# DG/DvKmnzB5jX/rkYRsAl1Or8fg4BAQZf0ZWsidpbsXmZHGBSnfMEF00Pkur3HLC
# atKNnSG0QVbj9wyZ5tlJIV2MtbUdxuQOa04ds+kv1p005nW4S/YoAXoXTBYpsW52
# HldDSvjDYDwfkn9I2Rf9gG8+E8hJlVuDv+k=
