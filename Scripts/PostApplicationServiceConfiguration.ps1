<#
.Synopsis
   Performs post application service deployment configuration
.DESCRIPTION
   Performs post application service deployment configuration using the values contained within $MRDefaultValues or $config.
#>
[CmdletBinding()]
Param
(
...
$postApplicationServiceConfigurationScript = New-ScriptExecution -Name 'Post Application Service Configuration' `
	-ErrorCode $ErrorCodes.PostApplicationServiceConfiguration `
	-Script {
...
Invoke-ExecutionScript -ExecutionScript $postApplicationServiceConfigurationScript
# SIG # Begin signature block
# MIIjhgYJKoZIhvcNAQcCoIIjdzCCI3MCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAZoFIZECDmCnhJ
# KcwtAii3KSNag3VNHrNwziowyJEpgKCCDYEwggX/MIID56ADAgECAhMzAAACUosz
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgIqS+2lYe
# 2otisw+zw75uxmLz25TCoKmTO1N8uxRRWMswQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQBNgXERzLtZW2maV1qWCpQBVzkLTZcdb9hiLdJf0XPA
# yyaRyl1lf7PgV/Q4h689BvFiGcphYqzdAl2KOKFTqc3sX9qOD+xV1WaAH4tOdxYi
# Tt8HZCSSJsFemQY193qj3gRQhg5garUQqvEfHeNTFTw/HRyx74t2Axg82RnpvDqW
# 9OTC4TFp95ZfF8ZdEFJWPsn6DbqZHiIl0mgtnkqw61wleI2xEvjwSt9iPRfuaDGc
# iECHuI4qPBoBC6aLZ0ZUu5R/37f9cMJ52c6MB8RQOeLwD67uLmtjvAos1cMnpt4X
# XFLD1yvNRNwhw5BhcbyOffLw1JWumabt21eJdsea7BNAoYIS5TCCEuEGCisGAQQB
# gjcDAwExghLRMIISzQYJKoZIhvcNAQcCoIISvjCCEroCAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIIoA4bohDGsXoWNt81PWD4CAzepBgsp3UKjw1h7p
# 59YTAgZhktY1BuMYEzIwMjExMjAxMDgzODA5Ljk3OFowBIACAfSggdCkgc0wgcox
...
# CSqGSIb3DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgPHR2a7/r
# hOS5LBcjVqhGN/Fd7gY0fbsMiFy3mJwFll8wgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
# DQEBCwUABIIBAIzD7LkSwojYTfr65VlxGe/o5s+DreshxJIrykZG8+vJ2PKL8KVe
# 3TYIcNt7san5J4UbtMAjdVY88zOsB8nv9giirnUeL3fuhiw/c2qQejCCC6kCM5im
# tp3Rge5SBX20AwWLvMI8brfh0UBlTxbYS6g+9uRNT6Ql51Tp7BHzZZTn2XcCrQQi
# GkuQ07HhEhqxuaEz5UCsUFeyxIoPlPxmtGfWSCtff5xHA1zI/3CLolNBgjT13sM0
# JLoeL4zWmjnk67LwTxIHvUoSUv71onjNdO+csjAJSy5uPE3tOBTFj/TOfG7j6ya8
# MLeMc8nKhVemiDhJTHgRAzXaQlEFqoBZPD4=
