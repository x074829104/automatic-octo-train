<#
	...
	* Requires ScriptSetup.ps1 to be previously imported and $Settings assigned using Get-SettingsObject
	* [Temporary] Don't call from dplManagementReporter.ps1 till script is finished being seperated
	* Call after setting MRDefaultValues

	Implementation Notes:
	* All variables and function need to be declared with a Script level
#>
...
$updateDefaultValuesScript = New-ScriptExecution -Name 'Updating default values' `
	-ErrorCode $ErrorCodes.UpdateDefaultValues `
	-Script {
		if(!(Get-Variable -Name MRDefaultValues -Scope Script -ErrorAction SilentlyContinue) -or !$MRDefaultValues)
		{
			# Initialize
			[hashtable]$script:MRDefaultValues = @{}
		}
		...
		if((Test-Path variable:Settings) -and $Settings)
		{
			...
			Update-ValueFromConfig -Settings $Settings -PropertyName 'MR.DataAccess.SqlPwd' -MRDefaultValues:([ref]$MRDefaultValues) -MRDefaultValueName 'MRSqlUserPassword' -HideValue
			# Runtime user
			Update-ValueFromConfig -Settings $Settings -PropertyName 'MR.RunTime.DataAccess.SqlUser' -MRDefaultValues:([ref]$MRDefaultValues) -MRDefaultValueName 'MRSqlRuntimeUserName'
			Update-ValueFromConfig -Settings $Settings -PropertyName 'MR.RunTime.DataAccess.SqlPwd' -MRDefaultValues:([ref]$MRDefaultValues) -MRDefaultValueName 'MRSqlRuntimeUserPassword' -HideValue
			# Certificates
			Update-ValueFromConfig -Settings $Settings -PropertyName 'MR.DataEncryptionCertThumbprint' -MRDefaultValues:([ref]$MRDefaultValues) -MRDefaultValueName 'DataEncryptionCertThumbprint'
			Update-ValueFromConfig -Settings $Settings -PropertyName 'MR.DataSigningCertThumbprint' -MRDefaultValues:([ref]$MRDefaultValues) -MRDefaultValueName 'DataSigningCertThumbprint'
		}

		if((Test-Path variable:EnforceEncryption) -and $EnforceEncryption)
		{
			Write-LogMessage -Message 'Enforcing MR encryption'
			$MRDefaultValues.MRSqlEncryptConnection = $true
			$MRDefaultValues.MRSqlTrustServerCertConnection = 'False'
		}

		if($MRDefaultValues.Count -gt 0)
		{
			...
			$defaultValueSettings = Remove-InvalidParameters -Command 'Set-MRDefaultValues' -Parameters $defaultValueSettings -ModuleName 'MRDeploy'
			Set-MRDefaultValues @defaultValueSettings
			Write-LogMessage -Message 'MRDefaultValues have been set'
			Assert-MRDefaultValues
			$MRDefaultValues.Clear()
		}
	}

Invoke-ExecutionScript -ExecutionScript $updateDefaultValuesScript
# SIG # Begin signature block
# MIIjhgYJKoZIhvcNAQcCoIIjdzCCI3MCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDEdZT3fzfur24t
# 8kKcHW75jeIgnuh9l95UWlYDYXGVB6CCDYEwggX/MIID56ADAgECAhMzAAACUosz
...
# BgEEAYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQg5K3XKURn
# EFrI4k4UEoXMWIYrumSD4pZ9q3Vj8jgCNZMwQgYKKwYBBAGCNwIBDDE0MDKgFIAS
# AE0AaQBjAHIAbwBzAG8AZgB0oRqAGGh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbTAN
# BgkqhkiG9w0BAQEFAASCAQADQgnJWOgw9lDZ51VajSXizx4daF26xMDepR/HdUbB
# 9a9D/mB81wBteaIcJYuUNOHWHIHoyZ5hWI8Sl4P2/z9OSm7teLj/gKp+2BZGdJOq
# FXAXqI+Pm+MTDQAnAaK2D6c3PWYRQLMccQYiNmQSNSTj7LKuG64Is6aE6TPZfEZy
# xcw/D7QpY5YtkkxEoLUwc6d95zX/ZIW0xp46ixIDfH2efksMy/T1u7gg+isCeN2O
# Golg/dHk1hHqwUKNSnZXyK22KRIn9njYSjBCAEc/DB5jCt6lWqastQjwrW+LJL1Z
# cJx12IWtQrAcr0pZu8w43coCefFApBPuBzkmh06AjWPLoYIS5TCCEuEGCisGAQQB
# gjcDAwExghLRMIISzQYJKoZIhvcNAQcCoIISvjCCEroCAQMxDzANBglghkgBZQME
# AgEFADCCAVEGCyqGSIb3DQEJEAEEoIIBQASCATwwggE4AgEBBgorBgEEAYRZCgMB
# MDEwDQYJYIZIAWUDBAIBBQAEIPu3RyA34XGvLlK9bUttCBevewYzDu/WRCmB+f/C
# USD7AgZhktY1BvEYEzIwMjExMjAxMDgzODEwLjI5MVowBIACAfSggdCkgc0wgcox
...
# CSqGSIb3DQEJAzENBgsqhkiG9w0BCRABBDAvBgkqhkiG9w0BCQQxIgQgL6esb+YG
# eNxAkmhYTduxSDNh0brg0SN71yLTub3URYIwgfoGCyqGSIb3DQEJEAIvMYHqMIHn
...
# DQEBCwUABIIBAH+2PtM1dB8muzx2RLV0eazLZzSRhCgvImGtdtTe/6RbsCTmSK1y
# /znyv8XImTtPtwQjMb109oeCqXumbEXbOmDhXfTqbra1+GMIJYTHbYViYF1W05YN
# vZC6Q0k61i+UmNcqjb9HoEDOsbirLGiKvKNbCQaLo1jrp90cTG/QdexidQmbf80R
# iogqhWYnC8rxpw5ScNcIYw2Pe71uE3jSakj8WKjqQ5oXlsyaN2v7otxEv/pfGn2o
# RUX/LKNxpfvh5TXGh4Pfi5CNA83GYt1PHnZe9+Xw5dDHCe2bCDUteOme/OVaxpec
# 9iaeq07FdyoTPWxhEwl8T27wLhFHQNc+iS8=
